...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    var themeColor8 = rootStyle.getPropertyValue("--theme-color-8").trim();
    var themeColor9 = rootStyle.getPropertyValue("--theme-color-9").trim();
    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("productFirm")) {
        var productFirm = document
          .getElementById("productFirm")
          .getContext("2d");
        var myChart = new Chart(productFirm, {
          type: "BarWithShadow",
          options: {
            plugins: {
              datalabels: {
          ...
          data: {
            labels: ["Coca Coala", "Lay’s", "Nestle", "Unilever", "PepsiCo", "MARS"], 
            datasets: [
              { 
                label: 'sdad',
                borderColor: themeColor1, 
                backgroundColor: themeColor1_10,
                data: [34000, 10223, 14236, 35120, 42123, 14741],
                borderWidth: 1
              }
            ]
          }
            ...
            datasets: [
              {
                ...
                borderColor: themeColor1,
                backgroundColor: themeColor1_10,
                data: [1000000, 1080600, 900782, 1502123, 875000, 1235001],
                borderWidth: 1
              }
            ]
          }
            ...
            datasets: [
              {
                ...
                borderColor: themeColor1,
                backgroundColor: themeColor1_10,
                data: [220000, 310000, 420000, 230000, 314000, 125000],
                borderWidth: 2
              }
            ]
          }
      ...
      if (document.getElementById("pieChart")) {
        ...
        var myChart = new Chart(pieChart, {
          type: "PieWithShadow",
          data: {
            labels: ["Молоко", "Хлеб", "Конфеты", "Хозтовары", "Химтовары", "Фрукты"],
            datasets: [
              {
                label: "",
